    ...
    if(req.session.userid){
        ...
        db.query(sql_str, [userid], (error, results) => {
            if (error) {     
                ...
                ErrorHtmlStream += fs.readFileSync(__dirname + '/../views/alert.ejs','utf8');
                ErrorHtmlStream += fs.readFileSync(__dirname + '/../views/footer.ejs','utf8'); 
                ...
                chatPageHtmlStream += fs.readFileSync(__dirname + '/../views/nav.ejs','utf8');  
                chatPageHtmlStream += fs.readFileSync(__dirname + '/../views/chat.ejs','utf8'); 
                chatPageHtmlStream += fs.readFileSync(__dirname + '/../views/footer.ejs','utf8'); 
